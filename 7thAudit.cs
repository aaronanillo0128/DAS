...
{
    public partial class _7thAudit : Form
    {
        ...
        private void _7thAudit_Load(object sender, EventArgs e)
        {
            ...
            //lblTotalTime.Text = dataGridView1.RowCount.ToString();
            //lblTotalEndTime.Text = dataGridView1.RowCount.ToString();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [7thAudit] as one_start,[7thEnd] as one_end,status7 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select remarks7,comment7 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string comment2;
                string remarks2;
                comment2 = reader["Comment7"].ToString();
                remarks2 = reader["Remarks7"].ToString();
        ...
        private void next_data()
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("SELECT COUNT(ID) FROM Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "' AND status7!=''", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            con.Close();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [7thAudit] as one_start,[7thEnd] as one_end,status7 from Temp_MasterAudit where AuditID = '" + id + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        private void btnEnd_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set Status7=@status7, Remarks7=@remarks7, Comment7=@comment7, [7thAudit]=@7thaudit, [7thEnd]=@7thend, Date=@date, Flag7=@flag7 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@status7", txtStatus.Text);
            cmd.Parameters.AddWithValue("@remarks7", tbRemarks.Text);
            cmd.Parameters.AddWithValue("@comment7", txtComment.Text);
            cmd.Parameters.AddWithValue("@date", date1);
            cmd.Parameters.AddWithValue("@7thaudit", lblFirstStart.Text);
            cmd.Parameters.AddWithValue("@7thend", lblFirstEnd.Text);
            ...
            if (RR == true)
            {
                ...
                //lblStartFinal1.Text = CRUD.dt.Rows[0]["1stAudit"].ToString();
                lblTotalTime.Text = CRUD.dt.Rows[0]["1stAudit"].ToString();
            }
            ...
            {
                var withBlock = CRUD.dt.Rows[0];
               // lblEndFinal1.Text = CRUD.dt.Rows[0]["7thEnd"].ToString();
                lblTotalEndTime.Text = CRUD.dt.Rows[0]["7thEnd"].ToString();
            }
            if (lblCount.Text == lblChecksheetCountTotal.Text)
            {
                ...
                string select = "Select * from Temp_MasterAudit where Status7 = 'NG' AND TypeofAudit != 'PS Process Audit' AND AuditID = '" + Monitoring._instance.MySelectedAuditID + "'";
            ...
            try
            {
                if (txtStatus.Text != "" && lblFirstStart.Text != "" && lblFirstEnd.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        cmd = new SqlCommand("update Temp_MasterAudit set Status7=@status7, Remarks7=@remarks7, Comment7=@comment7, [7thAudit]=@7thaudit, [7thEnd]=@7thend, Date=@date, Flag7=@flag7 where TypeofAudit = '" + lblTypeAudit.Text + "' AND AuditID= '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "' AND Section = '" + LOGIN.LoginSection + "'", con);
                        con.Open();
                        cmd.Parameters.AddWithValue("@id", ID);
                        cmd.Parameters.AddWithValue("@status7", txtStatus.Text);
                        cmd.Parameters.AddWithValue("@remarks7", tbRemarks.Text);
        ...
        private void jeButton6_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set TypeNG7= '" + cmbNG.Text + "', NGDetails7=@ngdetails7 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'  AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@ngdetails7", textBox6.Text);
            cmd.ExecuteNonQuery();
            con.Close();
            ...
            con.Open();
            cmd.Parameters.AddWithValue("@Date", date1);
            cmd.Parameters.AddWithValue("@freq", "7th");
