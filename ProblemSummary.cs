...
{
    public partial class ProblemSummary : Form
    {
        public static ProblemSummary _instance;
        ...
        private void DisplayData()
        {
            ...
            adapt = new SqlDataAdapter("select * from ProblemSummary where TypeofAudit = '" + lblTypeofAudit.Text + "' AND Section = '" + LOGIN.LoginSection + "'", con);
            adapt.Fill(dt);
        ...
        private void DisplayData2()
        {
            con.Open();
            DataTable dt = new DataTable();
            adapt = new SqlDataAdapter("select * from ProblemSummary where TypeofAudit = '" + lblTypeofAudit.Text + "' AND Section = '" + LOGIN.LoginSection + "' AND Status != 'OPEN'", con);
            adapt.Fill(dt);
        ...
        private void DisplayData3()
        {
            con.Open();
            DataTable dt = new DataTable();
            adapt = new SqlDataAdapter("select * from ProblemSummary where TypeofAudit = '" + lblTypeofAudit.Text + "' AND Section = '" + LOGIN.LoginSection + "' AND Status != 'CLOSED'", con);
            adapt.Fill(dt);
        ...
        private void ProblemSummary_Load(object sender, EventArgs e)
        {
