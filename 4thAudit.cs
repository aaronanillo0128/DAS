...
{
    public partial class _4thAudit : Form
    {
        ...
        private void _4thAudit_Load(object sender, EventArgs e)
        {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [4thAudit] as one_start,[4thEnd] as one_end,status4 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select remarks4,comment4 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string comment2;
                string remarks2;
                comment2 = reader["Comment4"].ToString();
                remarks2 = reader["Remarks4"].ToString();
        ...
        private void next_data()
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("SELECT COUNT(ID) FROM Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "' AND status4!=''", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            con.Close();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [4thAudit] as one_start,[4thEnd] as one_end,status4 from Temp_MasterAudit where AuditID = '" + id + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        private void btnEnd_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set Status4=@status4, Remarks4=@remarks4, Comment4=@comment4, [4thAudit]=@4thaudit, [4thEnd]=@4thend, Date=@date, Flag4=@flag4 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@status4", txtStatus.Text);
            cmd.Parameters.AddWithValue("@remarks4", tbRemarks.Text);
            cmd.Parameters.AddWithValue("@comment4", txtComment.Text);
            cmd.Parameters.AddWithValue("@date", date1);
            cmd.Parameters.AddWithValue("@4thaudit", lblFirstStart.Text);
            cmd.Parameters.AddWithValue("@4thend", lblFirstEnd.Text);
            ...
            if (RR == true)
            {
                ...
                lblTStart.Text = CRUD.dt.Rows[0]["4thAudit"].ToString();
            ...
            {
                var withBlock = CRUD.dt.Rows[0];
                lblTEnd.Text = CRUD.dt.Rows[0]["4thEnd"].ToString();
                //TotalTimeTo.Text = CRUD.dt.Rows[0]["4thEnd"].ToString();
            }
            if (lblCount.Text == lblChecksheetCountTotal.Text)
            {
                ...
                string select = "Select * from Temp_MasterAudit where Status4 = 'NG' AND TypeofAudit != 'PS Process Audit' AND AuditID = '" + Monitoring._instance.MySelectedAuditID + "'";
            ...
            try
            {
                if (txtStatus.Text != "" && lblFirstStart.Text != "" && lblFirstEnd.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        cmd = new SqlCommand("update Temp_MasterAudit set Status4=@status4, Remarks4=@remarks4, Comment4=@comment4, [4thAudit]=@4thaudit, [4thEnd]=@4thend, Date=@date, Flag4=@flag4 where TypeofAudit = '" + lblTypeAudit.Text + "' AND AuditID= '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "' AND Section = '" + LOGIN.LoginSection + "'", con);
                        con.Open();
                        cmd.Parameters.AddWithValue("@id", ID);
                        cmd.Parameters.AddWithValue("@status4", txtStatus.Text);
                        cmd.Parameters.AddWithValue("@remarks4", tbRemarks.Text);
        ...
        private void picPrevious_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnDoneAudit_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    cmd = new SqlCommand("update Temp_MasterAudit set Status5=@status5, Status6=@status6, Status7=@status7, Remarks5=@remarks5, Remarks6=@remarks6, Remarks7=@remarks7, Comment5=@comment5, Comment6=@comment6, Comment7=@comment7, TypeNG5=@typeng5, TypeNG6=@typeng6, TypeNG7=@typeng7, NGDetails5=@ngdetails5, NGDetails6=@ngdetails6, NGDetails7=@ngdetails7, Date=@date, [5thAudit]=@5audit, [6thAudit]=@6audit, [7thAudit]=@7audit, [5thEnd]=@5end, [6thEnd]=@6end, [7thEnd]=@7end, Flag5=@flag5, Flag6=@flag6, Flag7=@flag7 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'", con);
                    con.Open();
                    cmd.Parameters.AddWithValue("@id", ID);
        ...
        private void jeButton6_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set TypeNG4= '" + cmbNG.Text + "', NGDetails4=@ngdetails4 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'  AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@ngdetails4", textBox6.Text);
            cmd.ExecuteNonQuery();
            con.Close();
