...
{
    public partial class Pending_Approval : Form
    {
        public static Pending_Approval _instance;
        ...
        private void DisplayData()
        {
            ...
            adapt = new SqlDataAdapter("select DISTINCT AuditID,Auditor,Date,Line,Process,TypeofAudit,Series,[View],[delete],[Change],Model,Shift,First_Approver,Second_Approver,Third_Approver from Approval where First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc", con);
            adapt.Fill(dt);
        ...
        private void Admin()
        {
            con.Open();
            DataTable dt = new DataTable();
            adapt = new SqlDataAdapter("select DISTINCT AuditID,Auditor,Date,Line,Process,TypeofAudit,Series,[View],[delete],[Change],Model,Shift,First_Approver,Second_Approver,Third_Approver from Approval where Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc", con);
            adapt.Fill(dt);
            dataGridView1.DataSource = dt;
            con.Close();
        ...
        private void DisplayData2()
        {
            con.Open();
            DataTable dt = new DataTable();
            adapt = new SqlDataAdapter("Select DISTINCT AuditID,Auditor,First_DateApproved,Line,Process,Series,TypeofAudit,[delete],Shift,Model from Approval where First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND First_Status = 'Done'", con);
            adapt.Fill(dt);
            ...
            dataGridView2.Columns[2].HeaderText = "DateApproved";
        ...
        public void searchACC()
        {
            ...
            if (cmbSearchBy.Text == "Audit ID")
            {
                ...
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where AuditID like @auditid AND First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
            ...
            else if (cmbSearchBy.Text == "Date")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Date like @date AND First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
            ...
            else if (cmbSearchBy.Text == "Line")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Line like @line AND First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
            ...
            else if (cmbSearchBy.Text == "Series")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Series like @series AND First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
            ...
            else if (cmbSearchBy.Text == "Model")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Model like @model AND First_Approver = '" + LOGIN.loginName + "' AND Section = '" + LOGIN.LoginSection + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
        ...
        public void searchACC2()
        {
            ...
            if (cmbSearchBy.Text == "Audit ID")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where AuditID like '%"+txtSearch.Text + "%' AND First_Approver = '" + LOGIN.loginName + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
                    DataTable dt = new DataTable();
            ...
            else if (cmbSearchBy.Text == "Date")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Date like @date AND First_Approver = '" + LOGIN.loginName + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add(new SqlParameter("@date", "%" + Date.Text + "%"));
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
            ...
            else if (cmbSearchBy.Text == "Line")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Line like @line AND First_Approver = '" + LOGIN.loginName + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add(new SqlParameter("@line", "%" + txtSearch.Text + "%"));
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
            ...
            else if (cmbSearchBy.Text == "Series")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Series like @series AND First_Approver = '" + LOGIN.loginName + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add(new SqlParameter("@series", "%" + txtSearch.Text + "%"));
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
            ...
            else if (cmbSearchBy.Text == "Model")
            {
                using (SqlConnection conn = new SqlConnection(BBB))
                {
                    string sql = "select DISTINCT AuditID,Auditor,Date,Line,Process,Series,[View],[delete],[Change],Model,Shift from Approval where Model like @model AND First_Approver = '" + LOGIN.loginName + "' AND case when First_Status is NULL then 0 when First_Status = '' then 0 else 1 end=0 order by Date asc";
                    SqlCommand cmd = new SqlCommand(sql, conn);
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add(new SqlParameter("@model", "%" + txtSearch.Text + "%"));
                    SqlDataAdapter sda = new SqlDataAdapter(cmd);
        ...
        private void Pending_Approval_Load(object sender, EventArgs e)
        {
        ...
        private void Pending_Approval_MouseDown(object sender, MouseEventArgs e)
        {
        ...
        private void dataGridView1_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (dataGridView1.Rows[e.RowIndex].Cells[e.ColumnIndex].Value.ToString() == "👁️")
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    ApprovalLookup lookup = new ApprovalLookup();
                    ...
                    lookup.lblTypeofAudit.Text = this.dataGridView1.CurrentRow.Cells["TypeofAudit"].Value.ToString();
...

            {
                ...
                DialogResult DialogResult1 = MessageBox.Show("Are you sure do you want DELETE this Audit Item?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void dataGridView2_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (dataGridView2.Rows[e.RowIndex].Cells[e.ColumnIndex].Value.ToString() == "❌")
            {
                ...
                if (DialogResult1 == DialogResult.Yes)
                {
                    ID1 = dataGridView2.Rows[e.RowIndex].Cells["AuditID"].Value.ToString();
                    cmd = new SqlCommand("delete tbl_AuditApproval where AuditID=@id", con);
                    con.Open();
                    cmd.Parameters.AddWithValue("@id", ID);
                    cmd.ExecuteNonQuery();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (cmbChecker.Text != "")
            {
                cmd = new SqlCommand("update tbl_AuditApproval set First_Approver=@firstapprover where AuditID=@auditid", con);
                con.Open();
                cmd.Parameters.AddWithValue("@auditid", lblAuditID.Text);
                cmd.Parameters.AddWithValue("@firstapprover", cmbChecker.Text);
                cmd.ExecuteNonQuery();
                con.Close();
        ...
        {
            DisapprovedItems disap = new DisapprovedItems();
            disap.ShowDialog();
        }
    }
    }
