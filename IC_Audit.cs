...
{
    public partial class IC_Audit : Form
    {
        public IC_Audit()
        {
            InitializeComponent();
        ...
        private void IC_Audit_Load(object sender, EventArgs e)
        {
        ...
        {
            btnProceedtoAudit2.Text = "Ink Leakage Stabilization Audit Checksheet";
        ...
        {
            btnProceedtoAudit3.Text = "Line Audit/Patrol";
        ...
        {
            btnSummary2.Text = "Ink Leakage Stabilization Audit Checksheet";
        ...
        {
            btnSummary3.Text = "Line Audit/Patrol";
