...
{
    public partial class _5thAudit : Form
    {
        ...
        private void _5thAudit_Load(object sender, EventArgs e)
        {
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [5thAudit] as one_start,[5thEnd] as one_end,status5 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select remarks5,comment5 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string comment2;
                string remarks2;
                comment2 = reader["Comment5"].ToString();
                remarks2 = reader["Remarks5"].ToString();
            ...
            try
            {
                if (txtStatus.Text != "" && lblFirstStart.Text != "" && lblFirstEnd.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        cmd = new SqlCommand("update Temp_MasterAudit set Status5=@status5, Remarks5=@remarks5, Comment5=@comment5, [5thAudit]=@5thaudit, [5thEnd]=@5thend, Date=@date, Flag5=@flag5 where TypeofAudit = '" + lblTypeAudit.Text + "' AND AuditID= '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
                        con.Open();
                        cmd.Parameters.AddWithValue("@id", ID);
                        cmd.Parameters.AddWithValue("@status5", txtStatus.Text);
                        cmd.Parameters.AddWithValue("@remarks5", tbRemarks.Text);
                        cmd.Parameters.AddWithValue("@comment5", txtComment.Text);
                        cmd.Parameters.AddWithValue("@date", date1);
                        cmd.Parameters.AddWithValue("@5thaudit", lblFirstStart.Text);
                        cmd.Parameters.AddWithValue("@5thend", lblFirstEnd.Text);
        ...
        private void next_data()
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("SELECT COUNT(ID) FROM Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "' AND status5!=''", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            con.Close();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [5thAudit] as one_start,[5thEnd] as one_end,status5 from Temp_MasterAudit where AuditID = '" + id + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        private void btnEnd_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set Status5=@status5, Remarks5=@remarks5, Comment5=@comment5, [5thAudit]=@5thaudit, [5thEnd]=@5thend, Date=@date, Flag5=@flag5 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@status5", txtStatus.Text);
            cmd.Parameters.AddWithValue("@remarks5", tbRemarks.Text);
            ...
            if (RR == true)
            {
                ...
                lblTStart.Text = CRUD.dt.Rows[0]["5thAudit"].ToString();
            ...
            {
                var withBlock = CRUD.dt.Rows[0];
                lblTEnd.Text = CRUD.dt.Rows[0]["5thEnd"].ToString();
               // TotalTimeTo.Text = CRUD.dt.Rows[0]["5thAudit"].ToString();
            }
            ...
            if (lblCount.Text == lblChecksheetCountTotal.Text)
            {
                ...
                string select = "Select * from Temp_MasterAudit where Status5 = 'NG' AND TypeofAudit != 'PS Process Audit' AND AuditID = '" + Monitoring._instance.MySelectedAuditID + "'";
        ...
        private void btnDoneAudit_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    cmd = new SqlCommand("update Temp_MasterAudit set Status6=@status6, Status7=@status7, Remarks6=@remarks6, Remarks7=@remarks7, Comment6=@comment6, Comment7=@comment7, TypeNG6=@typeng6, TypeNG7=@typeng7, NGDetails6=@ngdetails6, NGDetails7=@ngdetails7, Date=@date, [6thAudit]=@6audit, [7thAudit]=@7audit, [6thEnd]=@6end, [7thEnd]=@7end, Flag6=@flag6, Flag7=@flag7 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'", con);
                    con.Open();
                    cmd.Parameters.AddWithValue("@id", ID);
                    ...
                    {
                        var withBlock = CRUD.dt.Rows[0];
                        TotalTimeTo.Text = CRUD.dt.Rows[0]["5thEnd"].ToString();
        ...
        private void jeButton6_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set TypeNG5= '" + cmbNG.Text + "', NGDetails5=@ngdetails5 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'  AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@ngdetails5", textBox6.Text);
            cmd.ExecuteNonQuery();
            con.Close();
