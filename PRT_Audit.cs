...
{
    public partial class PRT_Audit : Form
    {
        public PRT_Audit()
        {
            InitializeComponent();
        ...
        private void PRT_Audit_Load(object sender, EventArgs e)
        {
        ...
        {
            btnProceedtoAudit1.Text = "Assembly Process Patrol Checksheet";
        ...
        {
            btnProceedtoAudit2.Text = "Hashira Checksheet";
        ...
        {
            btnSummary1.Text = "Assembly Process Patrol Checksheet";
        ...
        {
            btnSummary2.Text = "Hashira Checksheet";
