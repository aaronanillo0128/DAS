...
{
    public partial class _3rdAudit : Form
    {
        ...
        private void _3rdAudit_Load(object sender, EventArgs e)
        {
            ...
            //panel1.Location = new Point(351, 85);
            dataGridView1.CurrentCell = dataGridView1.Rows[0].Cells[2];
        }
        private void num_items()
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [3rdAudit] as one_start,[3rdEnd] as one_end,status3 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select Remarks3,Comment3 from Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string comment3;
                string remarks3;
                comment3 = reader["Comment3"].ToString();
                remarks3 = reader["Remarks3"].ToString();
                txtComment.Text = comment3;
                tbRemarks.Text = remarks3;
            }
            con.Close();
        }
            ...
            try
            {
                if (txtStatus.Text != "" && lblFirstStart.Text != "" && lblFirstEnd.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        cmd = new SqlCommand("update Temp_MasterAudit set Status3=@status3, Remarks3=@remarks3, Comment3=@comment3, [3rdAudit]=@3rdaudit, [3rdEnd]=@3rdend, Date=@date, Flag3=@flag3 where TypeofAudit = '" + lblTypeAudit.Text + "' AND AuditID= '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "' AND Section = '" + LOGIN.LoginSection + "'", con);
                        con.Open();
                        cmd.Parameters.AddWithValue("@id", ID);
                        cmd.Parameters.AddWithValue("@status3", txtStatus.Text);
                        cmd.Parameters.AddWithValue("@remarks3", tbRemarks.Text);
                        cmd.Parameters.AddWithValue("@comment3", txtComment.Text);
                        cmd.Parameters.AddWithValue("@date", date1);
                        cmd.Parameters.AddWithValue("@3rdaudit", lblFirstStart.Text);
                        cmd.Parameters.AddWithValue("@3rdend", lblFirstEnd.Text);
        ...
        private void next_data()
        {
            ...
            con.Open();
            SqlDataAdapter sda = new SqlDataAdapter("SELECT COUNT(ID) FROM Temp_MasterAudit where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + textBox7.Text + "' AND status3!=''", con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            con.Close();
        ...
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("select [3rdAudit] as one_start,[3rdEnd] as one_end,status3 from Temp_MasterAudit where AuditID = '" + id + "' AND Process = '" + lblProcess.Text + "' AND ChecksheetNo = '" + lblCount.Text + "'", con);
            SqlDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
                string first_audit;
        ...
        private void btnEnd_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set Status3=@status3, Remarks3=@remarks3, Comment3=@comment3, [3rdAudit]=@3rdaudit, [3rdEnd]=@3rdend, Date=@date, Flag3=@flag3 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "' AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@status3", txtStatus.Text);
            cmd.Parameters.AddWithValue("@remarks3", tbRemarks.Text);
            ...
            if (RR == true)
            {
                ...
                lblTStart.Text = CRUD.dt.Rows[0]["3rdAudit"].ToString();
            ...
            {
                var withBlock = CRUD.dt.Rows[0];
                lblTEnd.Text = CRUD.dt.Rows[0]["3rdEnd"].ToString();
            ...
            if (lblCount.Text == lblChecksheetCountTotal.Text)
            {
                ...
                string select = "Select * from Temp_MasterAudit where Status3 = 'NG' AND TypeofAudit != 'PS Process Audit' AND AuditID = '" + Monitoring._instance.MySelectedAuditID + "'";
        ...
        private void btnDoneAudit_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                try
                {
                    cmd = new SqlCommand("update Temp_MasterAudit set Status4=@status4, Status5=@status5, Status6=@status6, Status7=@status7, Remarks4=@remarks4, Remarks5=@remarks5, Remarks6=@remarks6, Remarks7=@remarks7, Comment4=@comment4, Comment5=@comment5, Comment6=@comment6, Comment7=@comment7, TypeNG4=@typeng4, TypeNG5=@typeng5, TypeNG6=@typeng6, TypeNG7=@typeng7, NGDetails4=@ngdetails4, NGDetails5=@ngdetails5, NGDetails6=@ngdetails6, NGDetails7=@ngdetails7, Date=@date, [4thAudit]=@4audit, [5thAudit]=@5audit, [6thAudit]=@6audit, [7thAudit]=@7audit, [4thEnd]=@4end, [5thEnd]=@5end, [6thEnd]=@6end, [7thEnd]=@7end, Flag4=@flag4, Flag5=@flag5, Flag6=@flag6, Flag7=@flag7 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'", con);
                    con.Open();
                    cmd.Parameters.AddWithValue("@id", ID);
                    ...
                    {
                        var withBlock = CRUD.dt.Rows[0];
                        TotalTimeTo.Text = CRUD.dt.Rows[0]["3rdEnd"].ToString();
        ...
        private void jeButton6_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("update Temp_MasterAudit set TypeNG3= '" + cmbNG.Text + "', NGDetails3=@ngdetails3 where AuditID = '" + Monitoring._instance.MySelectedAuditID + "'  AND ChecksheetNo= '" + lblCount.Text + "' AND Process= '" + lblProcess.Text + "'", con);
            con.Open();
            cmd.Parameters.AddWithValue("@id", ID);
            cmd.Parameters.AddWithValue("@ngdetails3", textBox6.Text);
            cmd.ExecuteNonQuery();
            con.Close();
