...
{
    public partial class IH_Audit : Form
    {
        ...
        {
            btnProceedtoAudit1.Text = "GENBA Checklist";
        ...
        {
            btnProceedtoAudit2.Text = "Process Analysis Daily Audit Checksheet";
        ...
        {
            btnProceedtoAudit3.Text = "Assembly Process Patrol";
        ...
        {
            btnSummary1.Text = "GENBA Checklist";
        ...
        {
            btnSummary2.Text = "Process Analysis Daily Audit Checksheet";
        ...
        {
            btnSummary3.Text = "Assembly Process Patrol";
        ...
        private void IH_Audit_Load(object sender, EventArgs e)
        {
